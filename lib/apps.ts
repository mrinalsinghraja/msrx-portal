...
export interface App {
  ...
  initials: string;
  /** AA-compliant against white; used for link text and row hover. */
  accent: string;
  /** Pale wash used behind the monogram and on hover. */
  tint: string;
  platform: Platform;
  category: Category;
...
export const apps: App[] = [
  ...
  },
  {
    ...
    actionLabel: "App Store",
    tagline: "Shrink PDFs on-device without losing quality",
    description:
      "Compress PDF files on your iPhone or iPad. Everything runs on-device, so the file never leaves your phone.",
    features: [
  ...
  },
  {
    ...
    actionLabel: "App Store",
    tagline: "Compliant passport photos without the studio",
    description:
      "Generate compliant passport and visa photos from your iPhone. Frame, crop and export to the specification you need.",
    features: [
      "Passport and visa photo specifications",
      "Automatic framing and cropping",
      "Export ready to print or submit",
      "iPhone and iPad",
    ],
  },
];
